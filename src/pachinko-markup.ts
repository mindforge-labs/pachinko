    ...
    <div class="stack-carousel-panel" role="dialog" aria-modal="true" aria-labelledby="stack-carousel-heading">
      ...
      <section class="prompt-builder" aria-labelledby="prompt-builder-heading">
        ...
        <div id="prompt-output" class="prompt-output" hidden>
          <label for="gemini-system-prompt">System prompt ready to paste into Gemini</label>
          <textarea id="gemini-system-prompt" readonly spellcheck="false"></textarea>
          <button id="copy-prompt" class="prompt-copy-action" type="button">COPY PROMPT</button>
        </div>
        <div id="gemini-guide-output" class="prompt-output guide-output" hidden>
          <label for="gemini-guide">Implementation guide generated by Gemini</label>
          <textarea id="gemini-guide" readonly spellcheck="false"></textarea>
          <button id="copy-guide" class="prompt-copy-action" type="button">COPY GUIDE</button>
        </div>
      </section>
    </div>
  </div>
