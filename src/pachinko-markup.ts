    ...
    <div class="stack-carousel-panel" role="dialog" aria-modal="true" aria-labelledby="stack-carousel-heading">
      <header class="stack-carousel-head">
        ...
        <div class="stack-carousel-actions">
          <button id="stack-carousel-minimize" class="stack-carousel-action" type="button" aria-label="Minimize stack popup" aria-expanded="true">—</button>
          <button id="stack-carousel-reset" class="stack-carousel-action" type="button" aria-label="Reset pachinko">↻</button>
        </div>
      </header>
    ...
    <article class="machine" id="pachislot-machine" data-state="idle" aria-label="Nocturne Nova tech stack spinner cabinet">
      ...
      <section class="reel-bay" aria-label="Tech stack reels">
        ...
        <div class="reel-frame">
          ...
          <div class="reel" data-reel="1" data-layer="be" data-state="stopped" data-symbol="node" aria-label="Backend reel">
            <div class="reel-strip" aria-hidden="true">
              <div class="tech-tile" data-layer="be"><img class="tech-icon" src="/devicons/go.svg" alt=""></div>
              <div class="tech-tile" data-layer="be"><img class="tech-icon" src="/devicons/rust.svg" alt=""></div>
              <div class="tech-tile" data-layer="be"><img class="tech-icon" src="/devicons/django.svg" alt=""></div>
              <div class="tech-tile" data-layer="be"><img class="tech-icon" src="/devicons/nodejs.svg" alt=""></div>
            ...
            <div class="reel-result tech-tile" data-layer="be" role="img" aria-label="Node.js">
              <img class="tech-icon" src="/devicons/nodejs.svg" alt="">
            </div>
          </div>
