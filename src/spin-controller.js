import { pickTech } from './techstack.js';

const DEFAULT_SYMBOLS = ['react', 'node', 'postgres', 'vue', 'go', 'mongo'];
...
export class SpinController {
  ...
  start() {
    ...
    this.#clearTimers();
    this.phase = 'spinning';
    this.reels = Array.from({ length: this.reelCount }, (_, index) => ({ index, state: 'spinning', symbol: null }));
    this.#emit('start');
